  ...
  <div>
    <div class="sendInvoiceGrid">
      ...
      <div class="sidebar p-4">
        <h2 class="font-bold text-lg">Angebot versenden</h2>
        <hr class="my-4" />
...
Im Anhang finden Sie das Angebot {{ invoice.invoice_number }} vom {{ invoice.invoice_date }}.
Bei Fragen stehen wir Ihnen gerne zur Verfügung.

Mit freundlichen Grüßen
Christian Bucher`,
      loadingBtn: false,
      loadingBtnText: "Angebot versenden",
    };
  },
  methods: {
    sendInvoiceViaEmail() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.loadingBtnText = "Angebot erfolgreich versendet";
          setTimeout(() => {
            this.loadingBtnText = "Angebot versenden";
          }, 3000);
        })
        .catch((error) => {
          this.loadingBtn = false;
          ...
          console.log(error);
          window.alert(
            "Email konnte nicht versendet werden... Bitte versuchen Sie es später erneut."
          );
        });
    },
  },
